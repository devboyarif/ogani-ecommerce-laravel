                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                @if (Session::has('coupon') && $cart_has != 0)
                                    ...
                                    <div class="checkout__order__subtotal">Coupon Discount <span>tk{{ session()->get('coupon')['coupon_discount'] }} OFF</span></div>
                                    <div class="checkout__order__subtotal">Grand Total <span>tk{{ $sub_total - session()->get('coupon')['coupon_discount'] }}</span></div>
                                @else             
                                    <div name="total_price" class="checkout__order__subtotal">Subtotal <span>tk{{ $sub_total }}</span></div>
                                @endif                       
                                <button type="submit" class="site-btn">Procced to payment</button>
                            </div>
